...
void accept(struct marksheet list[100],int s)
{
    ...
    for(i=1;i<=s;i++)
    {
        ...
        gets(list[i].fname);
        fflush(stdin);
        printf("enter school code and schoo name:\n");
        gets(list[i].sname);
...
void display(struct marksheet list[100],int s)
{
    ...
    for(i=1;i<=s;i++)
    {
        ...
        printf("|___|_____________|______________________|__________|\n");
        printf("|         |                                      |          |               |             |                          |                          |\n");
        printf("|SUB CODE |             SUBJECT                  |  THEORY  |    /PR/IA     |    TOTAL    |       TOTAL(IN WORDS)    |     POSITIONAL GRADE     |\n");
        printf("|         |                                      |          |               |             |                          |                          |\n");
        printf("|___|_____________|___|_____|____|________|_________|\n");
...
void topper(struct marksheet list[100],int s)
{
    ...
    for(i=1;i<=s;i++)
    {
        ...
        printf("|SUB CODE |             SUBJECT                  |  THEORY  |    /PR/IA     |    TOTAL    |       TOTAL(IN WORDS)    |     POSITIONAL GRADE     |\n");
        printf("|         |                                      |          |               |             |                          |                          |\n");
        printf("|___|_____________|______________________|_______|__________|_______________|_____________|\n");
        printf("|301      |  ENGLISH CORE                        |   %3.3d    |      %3.3d      |     %3.3d     |        ",list[i].tmark[0],list[i].pmark[0],list[i].tmark[0]+list[i].pmark[0]);
        numtoalpha(list,i,0);
        grade(list,i,0);
        printf("|         |                                      |          |               |             |                          |                          |\n");
